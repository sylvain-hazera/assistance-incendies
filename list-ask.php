...
$result = Ask::loadWithFilters($filters);
$Asks = $result['Asks'];
$nbAsks = $result['count'];

$nbPages = ceil($nbAsks / NB_OFFERS_PER_PAGE);
if ($currentPage == 0){
    $currentPage = 1;
}
    ...
    <div class="container">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <?= $Ask->getCategory()->getName() . ' | ' . $Ask->getCity()->getName() ?> | Publiée le : <?= date("d/m/Y", strtotime($Ask->getDateCreation()) ); ?>
            </div>
            <div class="card-body">
                <p class="card-text"><?= $Ask->getDescription() ?></p>
                <div style="display: flex; justify-content: right">
                    <a href="contact-announcer.php?ask=<?= $Ask->getId() ?>" class="btn btn-primary">
